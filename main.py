...
#variables booleanas para definir si un cliente se registro, si una venta se realizo..
    ...
    #2 OPC BUCLE PRINCIPAL
        ...
        if preciovuelo > 0: 
            ...
            if respuesta_reserva == 'S':
                ...
                id_cliente+=1 #incremento el contador de id pasajes.
                print("\n--- ¡Boleto reservado! ---")
                print("Por favor, diríjase a '3. Gestionar Ventas' para completar la compra.")
                print(f"Reserva para: {reserva_destino} el {reserva_fecha_ida} por ${reserva_precio} ARS. PASAJE : {id_pasaje}")
   ...
   #BUCLE PRINCIPAL OPCION 3 
        ...
        if opcion_ventas == '1': # Procesar reserva
            ...
            # Limpiamos la reserva pendiente, ya que fue procesada
                ...
                print(f"Precio: ${venta_precio} ARS")
            ...
            if not reserva_pendiente:
                ...
                confirmacion_cancelar = input(f"¿Está seguro de cancelar la reserva para {reserva_destino} ({reserva_fecha_ida} Pasaje: {id_pasaje})? (S/N): ").upper()
...
#BUCLE PRINCIPAL OPCION 4 
        ...
        if not venta_registrada:
            ...
            print(f"ID de Venta: {venta_id_unico}")
            print(f"Pasaje {id_pasaje} : Destino: {venta_destino}")
            print(f"Precio: ${venta_precio} ARS") 
