...
while True:
    ...
    if opcion_principal=='1':
        while True: 
            ...
            print("5. Volver al Menú Principal") # Opción para salir del submenú de clientes
            ...
            #OPCION 2 SUB MENU 
                ...
                orreo_cliente= input("Ingrese Correo de Contacto del nuevo cliente: ")
            ...
            #OPCION 3 SUB MENU
                ...
                if not cliente_existe: #si no hay cliente ( cliente_existe=false)
                ...
                # Mostramos el ID del cliente actual
                    ...
                    nueva_razonsocial_input = input(f"Nueva Razón Social ({razonsocial_cliente}): ")
                    if nueva_razonsocial_input:
                        razonsocial_cliente = nueva_razonsocial_input 
                
                    nuevo_cuit_input = input(f"Nuevo CUIT ({cuit_cliente}): ")
                    if nuevo_cuit_input:
                        cuit_cliente = nuevo_cuit_input
                    
                    nuevo_correo_input = input(f"Nuevo Correo ({correo_cliente}): ")
                    if nuevo_correo_input:
                        correo_cliente = nuevo_correo_input 
        ...
        #OPCION 4 SUB MENU
                ...
                if not cliente_existe:
                    ...
                    if confirmacion == 'S':
                        ...
                        correo_cliente = ""
                        cliente_existe = False
                    # No reiniciamos id_cliente a 0 aquí, porque queremos que los nuevos clientes
                    # tengan un ID que siga la secuencia.
                        print("Cliente eliminado. Volver al MENU PRINCIPAL")
                    else:
                        print("Operación cancelada.")
                input("Presione Enter para continuar...")
            # OPCION 5 SUB MENU (Volver al Menú Principal)
            elif opcion_clientes == '5':
                print("Volviendo al Menú Principal...")
                break  # Sale del bucle del submenú de clientes, regresando al bucle principal
    ...
    #2 OPC BUCLE PRINCIPAL
        ...
        if preciovuelo > 0: 
            respuesta_reserva = input("Ingrese Y para confirmar el boleto, ingrese N para cancelar la operación: ").upper()
            
            if respuesta_reserva == 'Y':
                ...
                print(f"Reserva nr pasaje: {id_pasaje }para: {reserva_destino} el {reserva_fecha_ida} por ${reserva_precio} ARS")
   ...
   #BUCLE PRINCIPAL OPCION 3 
        ...
        if opcion_ventas == '1': # Procesar reserva
            ...
            if not reserva_pendiente:
                ...
                print("\n--- Detalles de la Reserva Pendiente n:---",)
            ...
            # Limpiamos la reserva pendiente, ya que fue procesada
                ...
                print(f"Se enviara a su correo:",{venta_correo},"el cupon de pago e indicaciones para finalizar la venta")
            else:
...
# BUCLE PRINCIPAL OPCION 5
        ...
        if not venta_registrada:
            ...
            if confirmacion_arrepentimiento == 'S':
                ...
                # global venta_registrada, venta_cliente_rs, venta_cliente_cuit, venta_destino, venta_precio, venta_fecha, venta_id_unico
